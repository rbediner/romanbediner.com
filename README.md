...
- **Homepage mobile logo sizing**: the six-track grid leads with Agentic Society and the NC Courage crest as a centered current-work row, followed by Disney, AWS, and Laser Light Communications as a separate operating-background row. Generous row spacing and per-mark optical sizing keep the official color marks legible without crowding or clipping.
