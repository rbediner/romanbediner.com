...
- Resources presentation contract:
  ...
  - Its shared carousel runtime uses `resources-carousel.js?v=20260719`, so a browser with an older cached runtime still receives the correct `Page 1 of 10` PDF-preview language and navigation.
