...
- Framework stage icons use an optical vertical alignment offset (`top: -5px`) in `/styles/framework.css` to keep icon glyphs visually centered against stage pills.
