...
- **Homepage mobile logo sizing**: a three-column grid leads with Agentic Society and the NC Courage crest as a centered current-work row, followed by Disney, AWS, and Laser Light Communications in three equal operating-background columns. Generous gutters and per-mark optical sizing keep the official color marks legible without crowding or clipping.
