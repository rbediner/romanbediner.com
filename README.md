...
- **Homepage mobile logo sizing**: a six-track grid gives Agentic Society and the NC Courage crest a compact centered current-work row, followed by Disney+, AWS, and Laser Light Communications in three evenly spaced operating-background columns. Generous gutters and per-mark optical sizing keep the color treatments legible without crowding or clipping.
