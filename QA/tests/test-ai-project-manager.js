...
const required = ['data-resource-slug="ai-project-manager"', 'Download the Project Manager Skill', 'What the Agent Does Each Day', 'One Tracker, Narrow Scope, Earned Trust', 'never invent an owner or decision', 'class="fleet-diagram fleet-zoomable-diagram pm-diagram"', 'fleet-diagram-zoom.js', 'drive.google.com/uc?export=download'];
