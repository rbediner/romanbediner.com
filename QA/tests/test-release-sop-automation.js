...
assert(browserSmokeText.includes('shouldIgnoreRuntimeIssue'), 'browser smoke must classify known environment-level runtime noise explicitly');
assert(!browserSmokeText.includes('static.cloudflareinsights.com'), 'browser smoke must not suppress Cloudflare CSP violations');
