...
node scripts/monitor-ci-run.js --branch staging --sha "${STAGING_SHA}" --timeout 1800 --interval 15
...
node scripts/monitor-ci-run.js --branch prod --sha "${STAGING_SHA}" --timeout 1800 --interval 15
